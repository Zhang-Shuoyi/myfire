package com.zhangshuoyi.myfire.rule.pojo;

import com.zhangshuoyi.myfire.rule.enums.HttpStatusEnum;
...
public class ResponseResult<T> {
     ...
     */
    private static <T> ResponseResult<T> response(Integer code, Boolean status,
    ...
    public static <T> ResponseResult<T> success() {
        return response(HttpStatusEnum.SUCCESS.getCode(), true,
                HttpStatusEnum.SUCCESS.getDesc(), null);
    }
    /**
     * 成功返回（枚举参数）
     *
    ...
    {
        return response(httpResponseEnum.getCode(), true,
                httpResponseEnum.getDesc());
    }
    /**
     * 成功返回（状态码+返回信息）
     *
     ...
     * @return {@link ResponseResult<T>}
     */
    public static <T> ResponseResult<T> success(Integer code, String message, T
            data) {
    ...
    public static <T> ResponseResult<T> success(T data) {
        return response(HttpStatusEnum.SUCCESS.getCode(), true,
                HttpStatusEnum.SUCCESS.getDesc(), data);
    }
    /**
     * 成功返回（返回信息）
     *
    ...
    public static <T> ResponseResult<T> fail() {
        return response(HttpStatusEnum.ERROR.getCode(), false,
                HttpStatusEnum.ERROR.getDesc(), null);
    }
    /**
     * 失败返回（枚举）
     *
    ...
    public static <T> ResponseResult<T> fail(HttpStatusEnum httpResponseEnum) {
        return response(httpResponseEnum.getCode(), false,
                httpResponseEnum.getDesc());
    }
    /**
     * 失败返回（状态码+返回信息）
     ...
     * @return {@link ResponseResult<T>}
     */
    public static <T> ResponseResult<T> fail(Integer code, String message, T
            data) {
    ...
    public static <T> ResponseResult<T> fail(T data) {
        return response(HttpStatusEnum.ERROR.getCode(), false,
                HttpStatusEnum.ERROR.getDesc(), data);
    }
    /**
     * 失败返回（返回信息）
     *
